...
import 'login_choose_your_role.dart';

class LogInVerifySmsCode extends StatefulWidget {
  const LogInVerifySmsCode({Key? key}) : super(key: key);

  @override
  State<LogInVerifySmsCode> createState() => _LogInVerifySmsCodeState();
}

class _LogInVerifySmsCodeState extends State<LogInVerifySmsCode> {
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  InkWell(
                      onTap: (){
                        Navigator.push(context, MaterialPageRoute(builder: (context) => const LogInChooseYourRole()));
                      },
