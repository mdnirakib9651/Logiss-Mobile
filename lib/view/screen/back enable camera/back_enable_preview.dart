...
class BackEnavleImagePreview extends StatefulWidget {
  XFile file;
  BackEnavleImagePreview({Key? key, required this.file}) : super(key: key);

  @override
  State<BackEnavleImagePreview> createState() => _BackEnavleImagePreviewState();
}

class _BackEnavleImagePreviewState extends State<BackEnavleImagePreview> {
  @override
